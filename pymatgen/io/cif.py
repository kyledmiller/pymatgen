...
class CifWriter:
    ...
    """
    def __init__(self, struct, symprec=None, angle_tolerance=5.0, write_magmoms=False, significant_figures=8):
        """
        Args:
            ...
            angle_tolerance (float): Maximum angle mismatch tolerated in basis 
                vectors while finding compatible spacegroup
        ...
        if symprec is not None:
            sf = SpacegroupAnalyzer(struct, symprec, angle_tolerance)
